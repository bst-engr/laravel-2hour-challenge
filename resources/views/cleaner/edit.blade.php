    ...
    {!! Form::model($cleaner, [
        ...
        'files' => true
            ...
            <div class="form-group" >
                {!! Form::label('Cleaner Cities', 'Cleaner Cities', ['class' => 'col-sm-3 control-label']) !!}
                <div class="col-sm-6">
                    @foreach($city as $item)
                        <div class="col-sm-4"><input type="checkbox" name="city_list[]" {{ in_array($item->id, $cleaner->city_list) ? 'checked="checked"' : '' }} value="{{$item->id}}" />{{$item->city_name}}</div>
